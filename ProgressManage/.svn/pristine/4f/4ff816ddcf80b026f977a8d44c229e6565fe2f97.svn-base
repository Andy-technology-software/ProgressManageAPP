...
@interface RemindTableViewCell()<UITextViewDelegate>
...
- (RemindTableViewCell *)advancedExpandableTextCellWithIdRemind:(NSString*)cellId
{
    RemindTableViewCell *cell = [self dequeueReusableCellWithIdentifier:cellId];
