...
//    self.spreadButton.titleLabel.textColor = [UIColor blackColor];
//    [self.spreadButton setTintColor:[UIColor blackColor]];
//    self.spreadButton.transform = CGAffineTransformIdentity;
//    self.spreadButton.backgroundColor = [MyController colorWithHexString:@"4c89f0"];
...
//    self.spreadButton.size = CGSizeMake(50, 50);
    if (_spreadButtonOpenViscousity) {
        [self spreadButtonViscousityFuncationCalFrame];
    }
}
