...
+(void)HelpfulHints:(NSString*)text addView:(UIView*)addView{
    UILabel  * Alertlabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREENWIDTH/2-80, SCREENHEIGHT/2-90, 160, 60)];
...
+ (NSString*)getUserid{
    ...
    return [self returnStr:[userDefaults objectForKey:@"userId"]];
}

+ (NSString*)getuserId{
    NSUserDefaults *accountDefaults = [NSUserDefaults standardUserDefaults];
    return [accountDefaults objectForKey:@"userId"];
}

+ (NSString*)getCName{
    NSUserDefaults*userDefaults=[NSUserDefaults standardUserDefaults];
    return [self returnStr:[userDefaults objectForKey:@"enterprise"]];
}
