...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (NO == self.navigationController.navigationBar.translucent) {
        ...
        self.searchSuggestionVC.view.frame = CGRectMake(10, CGRectGetMaxY(self.navigationController.navigationBar.frame) - self.view.py_y, self.view.py_width - 20, self.view.py_height + self.view.py_y);
