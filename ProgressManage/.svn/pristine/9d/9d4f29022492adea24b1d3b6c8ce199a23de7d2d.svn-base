...
//        _daycalenbarview.backgroundColor = [UIColor greenColor];
    }
...
//    self.daycalenbarview.backgroundColor = [UIColor orangeColor];
    ...
    for (int i = 0; i < 7; i ++) {
        ...
        self.daycalenlabel = [[UILabel alloc] initWithFrame:CGRectMake(i * ([MyController getScreenWidth] - 20)/7, 0, self.daycalenbarview.frame.size.width/7, 20)];
        
        self.daycalenlabel.text = weekarray[i];
        self.daycalenlabel.textAlignment = NSTextAlignmentCenter;
...
- (void)creatCollectionview
{
    ...
    self.calenCollectionview = [[UICollectionView alloc] initWithFrame:CGRectMake(0,0, [MyController getScreenWidth] - 20,100) collectionViewLayout:layout];
