...
- (void)initSubViews
{
    ...
    [self.finishBtn setTitleColor:[MyController colorWithHexString:@"4c89f0"] forState:UIControlStateNormal];
    ...
    [self.cancelBtn setTitleColor:[MyController colorWithHexString:@"ff7854"] forState:UIControlStateNormal];
...
- (void)setDataSource:(NSArray *)dataSource
{
    ...
    self.stateStr = [MyController returnStr:[NSString stringWithFormat:@"%@/%@",_dataSource[0],@(1)]];
