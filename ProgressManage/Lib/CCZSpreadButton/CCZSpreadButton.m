...
- (void)setImages:(NSArray *)images {
    ...
    for (int i = 0; i < images.count; i++) {
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"销售信息-默认1"] forState:UIControlStateNormal];
        [button setBackgroundImage:[UIImage imageNamed:@"销售详情-选中1"] forState:UIControlStateHighlighted];
        
        [button setTitle:images[i] forState:UIControlStateNormal];
        button.titleLabel.textColor = [UIColor blackColor];
        button.titleLabel.font = [UIFont systemFontOfSize:12];
        [button setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [button setTitleColor:[MyController colorWithHexString:@"4c89f0"] forState:UIControlStateHighlighted];
        if (self.selected == i) {
            [button setBackgroundImage:[UIImage imageNamed:@"销售详情-选中1"] forState:UIControlStateNormal];
            [button setBackgroundImage:[UIImage imageNamed:@"销售信息-默认1"] forState:UIControlStateHighlighted];
            [button setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
            [button setTitleColor:[MyController colorWithHexString:@"4c89f0"] forState:UIControlStateNormal];
        }
    }
}
...
//    [self.spreadButton setBackgroundImage:normalImage forState:UIControlStateNormal];
}
...
//    [self.spreadButton setBackgroundImage:selImage forState:UIControlStateSelected];
