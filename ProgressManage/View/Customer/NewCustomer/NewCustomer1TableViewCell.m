...
#define kMinHeigth 200.0

@interface NewCustomer1TableViewCell()<UITextViewDelegate>
@property (nonatomic, strong) UIView* bgView;
@property (nonatomic, strong) UILabel* leftLable;

@end
@implementation NewCustomer1TableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self != NULL) {
        ...
        self.leftLable = [MyController createLabelWithFrame:self.bgView.frame Font:14 Text:@"备注"];
...
- (NewCustomer1TableViewCell *)advancedExpandableTextCellWithIdNewCus:(NSString*)cellId
{
    NewCustomer1TableViewCell *cell = [self dequeueReusableCellWithIdentifier:cellId];
    
    if (cell == NULL) {
        cell = [[NewCustomer1TableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellId];
